...
class SixgillEnrichManager(object):
    ...
    def create_sixgill_client(self):
        ...
        try:
            sixgill_darkfeed_client = SixgillEnrichClient(self.client_id, self.client_secret, SIXGILL_CHANNEL_ID)
    ...
    def query_sixgill(self,entity_type,entity_value):
        ...
        try:
            ...
            raise SixgillManagerError(f" query_sixgill Error - Entity - {entity_value} - {err}")
