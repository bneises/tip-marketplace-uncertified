...
def main():
    ...
    if results:
        ...
        siemplify.result.add_attachment("Bandura Allowed IP Lists Output", "allowed_ip_lists.txt", json.dumps(results))
    
        # Add data table
        siemplify.result.add_data_table("Bandura Allowed IP Lists", construct_csv(results))
