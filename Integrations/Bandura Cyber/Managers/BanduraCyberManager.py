# ============================================================================#
# title           :BanduraCyberManager.py
# description     :This Module contain all Bandura Cyber operations functionality
...
class BanduraCyberManager(object):
    def __init__(self, username=None, password=None, api_token=None, verify_ssl=False):
        ...
        self.session.headers['Authorization'] = u"Bearer {}".format(self.access_token)
    ...
    def create_denied_domain_list(self, name, description=None, interval="60",
    ...
    def create_denied_ip_list(self, name, description=None, interval="60",
                              plugin_uuid="00000000-6714-4000-8000-000000000000",
                              enabled="true", type="manual"):
        """
        Retrieve existing object using object name
    ...
    def create_allowed_domain_list(self, name, description=None, interval="60",
                                   plugin_uuid="00000000-6714-4000-8000-000000000000",
                                   enabled="true", type="manual"):
        """
        Retrieve existing object using object name
    ...
    def create_allowed_ip_list(self, name, description=None, interval="60",
                               plugin_uuid="00000000-6714-4000-8000-000000000000",
                               enabled="true", type="manual"):
        """
        Retrieve existing object using object name
    ...
    def add_allowed_ip_entity(self, list_name, address="string", maskbit="int",
                              description=None, expires_date_time=""):
        """
        Retrieve existing object using object name
        :param group_name: {string}
        :return: {dict} Group details
    ...
    def add_allowed_domain_entity(self, list_name, domain="string",
                                  description=None, expires_date_time=""):
        """
        Retrieve existing object using object name
        :param group_name: {string}
    ...
    def add_denied_ip_entity(self, list_name, address="string", maskbits="int",
                             description=None, expires_date_time=""):
        """
        Retrieve existing object using object name
        :param group_name: {string}
    ...
    def add_denied_domain_entity(self, list_name, domain="string",
                                 description=None, expires_date_time=None):
        """
        Retrieve existing object using object name
        :param group_name: {string}
        :return: {dict} Group details
