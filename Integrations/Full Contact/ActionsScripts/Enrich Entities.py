    ...
    for ent in siemplify.target_entities:
        ...
        if domain:
            ...
            if 'status' not in res2 or res2['status'] != 404:
                ...
                try:
                    enrichment_json['FullContact_CompanyType'] = res2['details']['industries'][0]['name']
                except Exception as x:
                    print(x)
                try:
                    enrichment_json['FullContact_CompanyCountry'] = res2['details']['locations'][0]['country']
                except Exception as x:
                    print(x)
                try:
                    enrichment_json['FullContact_CompanyCity'] = res2['details']['locations'][0]['city']
                except Exception as x:
                    print(x)
        ...
        ent.additional_properties['FullContact_CompanyName'] = enrichment_json['FullContact_CompanyName']
        ent.additional_properties['FullContact_CompanyType'] = enrichment_json['FullContact_CompanyType']
        ent.additional_properties['FullContact_FoundedYear'] = enrichment_json['FullContact_FoundedYear']
        ent.additional_properties['FullContact_CompanyEmployees'] = enrichment_json['FullContact_CompanyEmployees']
        ent.additional_properties['FullContact_CompanyWebSite'] = enrichment_json['FullContact_CompanyWebSite']
        ent.additional_properties['FullContact_CompanyCountry'] = enrichment_json['FullContact_CompanyCountry']
        ent.additional_properties['FullContact_CompanyCity'] = enrichment_json['FullContact_CompanyCity']

        ent.additional_properties['FullContact_Person_Gender'] = enrichment_json['FullContact_Person_Gender']
        ent.additional_properties['FullContact_Person_Title'] = enrichment_json['FullContact_Person_Title']
        ent.additional_properties['FullContact_Person_Linkedin'] = enrichment_json['FullContact_Person_Linkedin']
