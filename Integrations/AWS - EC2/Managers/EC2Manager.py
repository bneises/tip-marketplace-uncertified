...
class EC2Manager(object):
    ...
    def __init__(self, aws_access_key, aws_secret_key, aws_default_region, verify_ssl=False):
        ...
        self.client = session.client('ec2', aws_access_key_id=aws_access_key,
    ...
    def stop_instances(self, instances_id_list, hibernate=False, dry_run=False, force=False):
        """
    ...
    def create_instance(self, image_id, instance_type, max_count, min_count, security_groups_id, dry_run=False):
        """
    ...
    def authorize_security_group_egress(self, group_id, ip_permissions_list, dry_run=False):
        """
    ...
    def authorize_security_group_ingress(self, group_id, ip_permissions_list, dry_run=False):
        """
    ...
    def revoke_security_group_ingress(self, group_id, ip_permissions_list, dry_run=False):
        """
    ...
    def revoke_security_group_egress(self, group_id, ip_permissions_list, dry_run=False):
        """
