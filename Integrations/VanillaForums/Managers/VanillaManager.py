...
class VanillaManager:
    ...
    def __init__(self, api_token, base_url):
        ...
        self.session.headers['Authorization'] = 'Bearer {0}'.format(api_token)
    ...
    def add_new_user(self, new_email, new_f_name, new_l_name, new_password, new_role_id, need_char, special_char, photo,
                     emailConfirmed, bypassSpam=True):
        """
    ...
    def give_user_role(self, role_id, user_id):
        ...
        try:
            ...
            if not 'roles' in res_json or len(res_json.get('roles')) == 0:
