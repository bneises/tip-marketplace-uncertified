...
def get_domain_ip(line: str) -> typing.List[str]:
    ...
    """
    m = EmailParserRegex.dom_regex.findall(' ' + line) + EmailParserRegex.ipv4_regex.findall(
        line) + EmailParserRegex.ipv6_regex.findall(line)
...
def parserouting(line: str) -> typing.Dict[str, typing.Any]:
    ...
    npline = npline.strip('\n')  # Remove any new-line
    raw_find_data = EmailParserRegex.date_regex.findall(npline)  # extract date on end line.
