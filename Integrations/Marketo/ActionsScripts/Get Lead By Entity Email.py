...
from SiemplifyUtils import output_handler, get_email_address, convert_dict_to_json_result_dict, \
    ...
    try:
        for ent in siemplify.target_entities:
            ...
            if ent.entity_type == EntityTypes.USER and valid_email is not None:
                lead_details = mc.execute(method='get_multiple_leads_by_filter_type', filterType='email',
