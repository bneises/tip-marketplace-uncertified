...
class PulsediveParser(object):
    ...
    def build_risk_factor_results(self, raw_data):
        return [self.build_risk_factor_data(risk_factor_json) for risk_factor_json in 
                raw_data.get('riskfactors', [])]
    ...
    def build_threat_object(self, raw_data, comments, news):
        return Threat(
            ...
            threat_risk_summary = self.build_risk_sumamry_results(raw_data.get('summary', {}).get('risk', {})),
            threat_news = news
        )
