...
from constants import DATA_ENRICHMENT_PREFIX, RISK_SCORE, RISK_NAME, VERY_LOW_RISK_FACTOR_IMAGE, LOW_RISK_FACTOR_IMAGE, MEDIUM_RISK_FACTOR_IMAGE, \
                        HIGH_RISK_FACTOR_IMAGE, CRITICAL_RISK_FACTOR_IMAGE, UNKNOWN_RISK_FACTOR_IMAGE
...
class PulsediveEntity(BaseModel):
    def __init__(self, raw_data, indicator_updated, risk_level, risk_recommended, indicator_retired):
...
class Indicator(PulsediveEntity):
    def __init__(self, raw_data, indicator_id, indicator_name, indicator_type, risk_level, risk_recommended,
                 manual_risk, retired_indicator, indicator_added, indicator_updated, indicator_seen,
                 indicator_probed, indicator_retired, recent, risk_factors, comments):
        super(Indicator, self).__init__(raw_data, indicator_updated, risk_level, risk_recommended, indicator_retired)
    ...
    def to_insight(self, threshold):
        risky = 0
        if int(RISK_SCORE.get(self.risk_level)) >= int(RISK_SCORE.get(RISK_NAME.get(threshold))):
            risky = 1
            
        content = ""
        content += "<table style='100%'><tbody>"
        content += "<tr><td style='text-align: left; width: 30%;'><strong style='font-size: 15px'>" \
                   "Detected:  <span {threshold_style}>{threshold}</span></strong></td>" \
            .format(threshold_style=" style='color: #ff0000'" if risky else "", threshold=self.threshold)
        content += "<td style='text-align: left; width: 30%;'><strong style='font-size: 15px'> Risk: " \
                   "{}</strong></td></tr>".format(threshold)
        content += "</tbody></table><br>"
        content += "<table style='100%'><tbody>"
        content += "<tr><td style='text-align: left; width: 30%;'><strong>Indicator: </strong></td>" \
                   "<td style='text-align: left; width: 30%'>{}</td></tr>".format(self.indicator_name)
        content += "<tr><td style='text-align: left; width: 30%;'><strong>Risk: </strong></td>" \
                   "<td style='text-align: left; width: 30%;'>{}</td></tr>".format(self.risk_level)
        content += "<tr><td style='text-align: left; width: 30%;'><strong>Recommended Risk: </strong></td>" \
                   "<td style='text-align: left; width: 30%;'>{}</td></tr>".format(self.risk_recommended)
        ...
        if self.risk_factors:
            ...
            for risk_factor in self.risk_factors:
                ...
                content += "<tr><td width='10%'><img {risk_image} height='20px' width='12px' /></td>".format(
                    risk_image=risk_image)
                content += "<td>{risk_description}</td></tr>".format(risk_description=risk_factor.risk_description)
        content += "</tbody></table><br>"
...
class Threat(PulsediveThreats):
    def __init__(self, raw_data, threat_id, threat_name, threat_category, threat_risk, threat_description, threat_wikisummary, 
                threat_wikireference, threat_retired, threat_timestamp_added, threat_timestamp_updated, threat_timestamp_seen, threat_timestamp_retired,
                threat_updated_last_domain, threat_comments, threat_other_names, threat_risk_summary, threat_news):
    ...
    def to_insight(self):
        ...
        content += "<table style='100%'><tbody>"
        content += "<tr><td style='text-align: left; width: 30%;'><strong style='font-size: 15px'>" \
                   "Threat Name:  <span>{threat_name}</span></strong></td>" \
            .format(threat_name=self.threat_name)
        content += "<td style='text-align: left; width: 30%;'><strong style='font-size: 15px'> Risk: " \
                   "{}</strong></td></tr>".format(self.threat_risk)
        content += "</tbody></table><br>"
        content += "<table style='100%'><tbody>"
        content += "<tr><td style='text-align: left; width: 30%; font-size: 15px'><strong>Category: </strong></td>" \
                   "<td style='text-align: left; width: 30%; font-size: 15px'>{}</td></tr>".format(self.threat_category)
        content += "</tbody></table><br>"
        if self.threat_risk_summary:
            content += "<p style='font-size: 15px'><strong>Risk Summary: </strong></p>"
            content += "<table><tbody>"
            content += "<tr><td style='text-align: left; width: 30%;'>Unknown: </td>" \
                       "<td style='text-align: center; width: 30%;'>{}</td></tr>".format(self.threat_risk_summary.threat_unknown_indicators)
            content += "<tr><td style='text-align: left; width: 30%;'>Very Low: </td>" \
                       "<td style='text-align: center; width: 30%;'>{}</td></tr>".format(self.threat_risk_summary.threat_none_indicators)
            content += "<tr><td style='text-align: left; width: 30%;'>Low: </td>" \
                       "<td style='text-align: center; width: 30%;'>{}</td></tr>".format(self.threat_risk_summary.threat_low_indicators)
            content += "<tr><td style='text-align: left; width: 30%;'>Medium: </td>" \
                       "<td style='text-align: center; width: 30%;'>{}</td></tr>".format(self.threat_risk_summary.threat_medium_indicators)
            content += "<tr><td style='text-align: left; width: 30%;'>High: </td>" \
                       "<td style='text-align: center; width: 30%;'>{}</td></tr>".format(self.threat_risk_summary.threat_high_indicators)
            content += "<tr><td style='text-align: left; width: 30%;'>Critical: </td>" \
                       "<td style='text-align: center; width: 30%;'>{}</td></tr>".format(self.threat_risk_summary.threat_critical_indicators)
            content += "<tr><td style='text-align: left; width: 30%;'><hr></td><td style='text-align: left; width: 30%;'><hr></td></tr>"
            content += "<tr><td style='text-align: left; width: 30%; font-size: 15px;'><strong>Total: </strong></td>" \
                       "<td style='text-align: center; width: 30%; font-size: 15px;'><strong>{}</strong></td></tr>".format(self.threat_risk_summary.threat_total_indicators)
            content += "</tbody></table><br>"
        if self.threat_wikisummary:
            content += "<p style='font-size: 15px'><strong>Wiki Summary: </strong></p>"
            content += "<table><tbody>"
            content += "<tr><td style='text-align: left; width: 30%;'>{threat_description}</td></tr><br>".format(
                            threat_description=self.threat_wikisummary)
            content += "</tbody></table><br>"
        if self.threat_news:
            content += "<p style='font-size: 15px'><strong>News: </strong></p>"
            content += "<table style='100%'><tbody>"
            content += "<tr><td style='text-align: left; width: 30%;'><strong>Title</strong></td>"
            content += "<td style='text-align: left; width: 30%;'><strong>Link</strong></td>"
            content += "<td style='text-align: left; width: 30%;'><strong>Published</strong></td></tr>"
            for news_items in self.threat_news:
                content += "<tr><td style='text-align: left; width: 30%; padding-right: 5px;'>{}</td>".format(news_items.news_title)
                content += "<td style='text-align: left; width: 30%;'><a href={0}>{1}</a></td>".format(news_items.news_link, news_items.news_channel)
                content += "<td style='text-align: left; width: 30%;'>{}</td></tr>".format(news_items.news_timestamp)
            content += "</tbody></table><br><br>"
...
class RiskSummaryData(BaseModel):
    def __init__(self, raw_data, threat_unknown_indicators, threat_none_indicators, threat_low_indicators,
                threat_medium_indicators, threat_high_indicators, threat_critical_indicators, threat_total_indicators):
...
class NewsData(BaseModel):
    def __init__(self, raw_data, news_title, news_channel, news_icon, news_link, 
                news_timestamp):
...
class Comment(BaseModel):
    def __init__(self, raw_data, comment_id, unique_id, user_comment, user_title, comment,
