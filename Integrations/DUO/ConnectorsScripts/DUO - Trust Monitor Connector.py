...
def create_event(siemplify, alert_id, trust_mon_event_data):
    ...
    event["Subject"] = trust_mon_event_data['type'] + " event for " + trust_mon_event_data['surfaced_auth']['user'][
        'name']
...
def create_alert(siemplify, alert_id, trust_mon_event_data):
    ...
    case_info = CaseInfo()
    case_info.name = trust_mon_event_data['type'] + " event for " + trust_mon_event_data['surfaced_auth']['user'][
        'name']
...
def get_duo_trust_mon_data(duoApi, adminSec, adminIntKey, days_back):
    ...
    try:
        ...
        trust_monitor = admin_api.get_trust_monitor_events_by_offset(maxtime=timestamp_now,
