...
class AsanaManager:
    ...
    def create_task(self, task_subject, project_id, description, assignee=None, due_date=None):
        """
        ...
        """
        data = {"data": {"name": task_subject, "assignee": assignee, "due_on": due_date, "projects": [project_id],
                         "notes": description}}
    ...
    def update_task(self, task_id, assignee, due_date, description):
        ...
        """
        data = {"data": {"assignee": assignee, "due_on": due_date, "notes": description}}
