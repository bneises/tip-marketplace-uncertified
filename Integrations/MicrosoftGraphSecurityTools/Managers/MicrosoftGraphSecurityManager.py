...
# Follow documentation for the official Microsoft Graph Security Integration on the marketplace, or
# see the readme documentation on my github below
...
# description    :This Module contains all Microsoft Graph API functionality
# author         :Daniel Harvey, Base authentication code from zivh@siemplify.co
# date           :5-NOV-2020
# python_version :3.7
# product_version: V1
# Doc            :https://github.com/snags141/SiemplifyIntegration_MicrosoftGraphSecurityTools
# ==============================================================================
...
GET_MFA_STATS_URL = "https://graph.microsoft.com/beta/reports/credentialUserRegistrationDetails"
GET_MAIL_RULES_URL = "https://graph.microsoft.com/v1.0/users/{}/mailFolders/inbox/messageRules"
MESSAGE_URL = "https://graph.microsoft.com/v1.0/users/{}/messages/{}"
LIST_MESSAGES_URL = "https://graph.microsoft.com/v1.0/users/{}/messages"
LIST_ATTACHMENTS_URL = "https://graph.microsoft.com/v1.0/users/{}/messages/{}/attachments"
DELETE_ATTACHMENTS_URL = "https://graph.microsoft.com/v1.0/users/{}/messages/{}/attachments/{}"
...
class MicrosoftGraphSecurityManager(object):
    def __init__(self, client_id: str, client_secret: str, certificate_path: str, certificate_password: str, tenant: str, verify_ssl: bool = False):
    ...
    def get_certificate_thumbprint_and_private_key(self, certificate_path, certificate_password):
        ...
        try:
            ...
            raise "Unable to read certificate file"
    ...
    def _build_api_parameters(provider_list: list = None, severity_list: list = None, status_list: list = None,
        ...
        if start_time:
            filter_params.append(f"createdDateTime gt {start_time.strftime(TIME_FORMAT)}")
    ...
    def delete_attachment(self, username, mail_id, attachment_id):
        ...
        """
        res = self.session.delete(DELETE_ATTACHMENTS_URL.format(str(username),str(mail_id),str(attachment_id)))
        if res.status_code == 204:
            response = {"status_code":"204","result":"success","output_message":"Deletion request completed successfully"}
        else:
            response = {"status_code":""+str(res.status_code),"result":"failed", "output_message":"Deletion request failed"}
    ...
    def delete_message(self, username, mail_id):
        ...
        if "," in username:
           ...
           for user_id in usernames:
               res = self.session.delete(MESSAGE_URL.format(str(user_id),str(mail_id)))
        else:
